...
const Top = () => {
    ...
    return (
        <div className={`fixed bottom-10 right-[5vw] flex flex-col items-center gap-3 ${isVisible ? 'visible' : 'hidden'}`}>
            <div onClick={scrollToTop} className="w-16 h-16 rounded-full bg-white flex items-center justify-center drop-shadow-2xl cursor-pointer text-[#939CA3] hover:text-white hover:bg-[#8064A2]" aria-label="Scroll to top">
            ...
            <div className='text-[14px] leading-[16px] font-semibold text-[#8064A2] p-1 bg-white drop-shadow-2xl lg:block hidden'>Go to top (Ctrl+Home)</div>
        </div>
    );
};
